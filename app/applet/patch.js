...
newContent = newContent.replaceAll('bg-[#1e3a5f]', 'bg-[#b88c3a]');
newContent = newContent.replaceAll('text-[#1e3a5f]', 'text-[#b88c3a]');
...
const newFeatureBlock = `
            <div>
              <div className="flex items-center font-bold text-[#b88c3a] mb-2 border-b border-gray-100 pb-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[#b88c3a] mr-2"></div>
                烟草企业健康保障行业特征
              </div>
