...
const replacement = `export function DocInterpretationCard() {
...
const startIdx = content.indexOf('export function DocInterpretationCard');
const endIdx = content.indexOf('export function DocRiskOpportunityCard');
